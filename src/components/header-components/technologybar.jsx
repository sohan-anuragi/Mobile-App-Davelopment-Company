  ...
  const technology = [
    {
      ...
      textIcon: [
        ...
        { text: "iOS", icon: technologyIcons.iOS, link: "/applayout/ios-app" },
        {
          ...
          link: "/applayout/react-development",
        },
        {
          text: "Flutter",
        ...
        {
          text: "Xamarin",
          icon: technologyIcons.Xamarin,
          link: "/applayout/xamarin-development",
        },
      ],
    },
    {
      ...
      textIcon: [
        {
          text: "WordPress",
          icon: technologyIcons.WordPress,
          link: "/applayout/wordpress-development",
        },
      ...
      textIcon: [
        {
          ...
          link: "/applayout/java-web-development",
        },
        {
          text: "Php",
          icon: technologyIcons.Php,
          link: "/applayout/php-web-development",
        },
        {
          text: "Node.Js",
          icon: technologyIcons.NodeJs,
          link: "/applayout/nodejs-development",
        },
        {
          text: "Oracle",
          icon: technologyIcons.Oracle,
          link: "/applayout/oracle-development",
        },
        {
          text: "Dot Net",
          icon: technologyIcons.DotNet,
          link: "/applayout/dotnet-development",
        },
      ],
    },
    {
      ...
      textIcon: [
        {
          ...
          link: "/applayout/blockchain-development",
        },
        {
          text: "AR & VR",
          icon: technologyIcons.ARVR,
          link: "/applayout/augmented-reality-development",
        },
        {
          text: "IOT",
        ...
        },
        {
          ...
          icon: technologyIcons.ArtificialIntelligence,
          link: "/applayout/ai-development",
        },
        {
          text: "Cloud Computing",
          icon: technologyIcons.CloudComputing,
          link: "/applayout/cloud-computing-development",
        },
      ],
    },
  ];
