...
import img5 from './Our-projects-img/project5.webp'
import img6 from './Our-projects-img/project6.webp'
...
export default function OurProjects(){
    ...
    useEffect(() => {
      ...
      const imgContainers = containerRef.current?.querySelectorAll(`.${styles['img-container']}`)
