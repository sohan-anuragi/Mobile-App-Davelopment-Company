...
export default function MainCarousel() {
  ...
  return (
    <div className={styles['outer-container']}>
      <h3 className={`${styles['carousel-heading']} ${visible[0] ?styles['carousel-heading2']:''}`}
      ...
      >
        We proudly present our rich portfolio, highlighting our commitment to excellence and successful projects that transform businesses.
      </p>
      <div 
      className={`${fixed ? styles['outer-fixed-container']: styles['not-fixed']}`}>
        <div className={fixed ? styles['cross-btn'] : styles['no-cross-btn']}
